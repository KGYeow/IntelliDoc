<template>
  <v-row class="pt-3 text-body-2">
    <v-col>
      <v-row class="pb-2">
        <v-col class="py-0" cols="12" md="2" lg="2">
          <v-label class="text-caption fw-bold">Name</v-label>
        </v-col>
        <v-col class="py-0" cols="12" md="10" lg="10">
          <div style="padding-top: 0.156rem;">{{ docInfo.name }}</div>
        </v-col>
      </v-row>
      <v-row class="pb-2">
        <v-col class="py-0" cols="12" md="2" lg="2">
        ...
        <v-col class="py-0" cols="12" md="10" lg="10">
          <div style="padding-top: 0.156rem;">{{ docInfo.currentVersion }}</div>
        </v-col>
      </v-row>
      <v-row class="pb-2">
        <v-col class="py-0" cols="12" md="2" lg="2">
        ...
        <v-col class="py-0" cols="12" md="10" lg="10">
          <div style="padding-top: 0.156rem;">{{ docInfo.type }}</div>
        </v-col>
      </v-row>
      <v-row class="pb-2">
        <v-col class="py-0" cols="12" md="2" lg="2">
        ...
        <v-col class="py-0" cols="12" md="10" lg="10">
          <div style="padding-top: 0.156rem;">
      ...
      <v-row class="pb-2">
        ...
        <v-col class="py-0" cols="12" md="10" lg="10">
          <div style="padding-top: 0.156rem;">{{ dayjs(docInfo.modifiedDate).format('DD MMM YYYY, hh:mm A') }}</div>
        </v-col>
      </v-row>
      <v-row class="pb-2">
        <v-col class="py-0" cols="12" md="2" lg="2">
      ...
      <v-row class="pb-2">
        ...
        <v-col class="py-0" cols="12" md="10" lg="10">
          <div style="padding-top: 0.156rem;">{{ docInfo.description ?? '-' }}</div>
        </v-col>
      </v-row>
    </v-col>
  </v-row>
  <v-row>
    <v-col class="d-flex justify-content-end">
      <v-btn
        ...
        size="small"
        flat
        @click="emit('open-related-doc', true)"
      >
        Related Documents
      </v-btn>
      <v-btn
...
const emit = defineEmits(['open-edit-modal', 'open-related-doc'])
